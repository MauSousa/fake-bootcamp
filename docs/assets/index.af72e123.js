const S=function(){const i=document.createElement("link").relList;if(i&&i.supports&&i.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))o(e);new MutationObserver(e=>{for(const a of e)if(a.type==="childList")for(const s of a.addedNodes)s.tagName==="LINK"&&s.rel==="modulepreload"&&o(s)}).observe(document,{childList:!0,subtree:!0});function c(e){const a={};return e.integrity&&(a.integrity=e.integrity),e.referrerpolicy&&(a.referrerPolicy=e.referrerpolicy),e.crossorigin==="use-credentials"?a.credentials="include":e.crossorigin==="anonymous"?a.credentials="omit":a.credentials="same-origin",a}function o(e){if(e.ep)return;e.ep=!0;const a=c(e);fetch(e.href,a)}};S();const E=()=>`
  ...
  `;var A="/assets/fundamentals.06dc8e60.svg";const H=()=>`
    <div class="container">
      <div class="row align-items-center justify-content-between">
        <div class="col-md">
          <img src=${A} class="img-fluid" alt="learn The Fundamentals" title="Learn The Fundamentals"/>
        </div>
  ...
  `;var R="/assets/react.785e9bcb.svg";const C=()=>`
    <div class="container">
      <div class="row align-items-center justify-content-between">
        ...
        <div class="col-md">
          <img src=${R} class="img-fluid" alt="learn React" title="Learn The Fundamentals"/>
        </div>
      </div>    
    </div>
  `,F=()=>`
...
`;var j="/assets/showcase.e36b53f3.svg";const Q=()=>`
  ...
  <div class="container">
    <div class="d-sm-flex align-items-center justify-content-between">
      ...
      <img src=${j} loading="lazy" class="img-fluid w-50 d-none d-md-block" alt="developer" title="Web Developer"/>
    </div>
  </div>
  `,B=()=>{const t=document.body,i=document.createElement("nav"),c=document.createElement("section"),o=document.createElement("section"),e=document.createElement("section"),a=document.createElement("section"),s=document.createElement("section"),n=document.createElement("section"),r=document.createElement("section"),l=document.createElement("section"),d=document.createElement("footer"),p=document.createElement("div"),u=document.createElement("div"),m=document.createElement("div"),b=N(),v=Q(),h=D(),g=E(),f=H(),q=C(),x=O(),y=T(),w=M(),L=I(),k=F();i.setAttribute("class","navbar navbar-expand-lg bg-dark navbar-dark py-3 fixed-top"),c.setAttribute("class","bg-dark text-light p-5 p-lg-3 pt-lg-5 text-center text-sm-start"),o.setAttribute("class","bg-primary text-light p-5"),e.setAttribute("class","p-3"),a.classList.add("p-5"),a.setAttribute("id","learn"),s.setAttribute("class","p-5 bg-dark text-light"),n.setAttribute("class","p-5"),u.setAttribute("id","questions"),u.setAttribute("class","p-3"),r.setAttribute("class","p-5 bg-primary"),m.setAttribute("class","p-3"),m.setAttribute("id","instructors"),l.classList.add("p-5"),d.setAttribute("class","p-5 bg-dark text-white text-center position-relative"),i.innerHTML=b,c.innerHTML=v,o.innerHTML=h,e.innerHTML=g,a.innerHTML=f,s.innerHTML=q,n.innerHTML=x,r.innerHTML=y,l.innerHTML=w,d.innerHTML=L,p.innerHTML=k,t.append(i),t.append(c),t.append(o),t.append(e),t.append(a),t.append(s),t.append(u),t.append(n),t.append(m),t.append(r),t.append(l),t.append(d),t.append(p)};B();
